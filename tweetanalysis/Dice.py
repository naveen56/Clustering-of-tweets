"""
 @desc:calculate the dice-coefficient similarity between two strings
    ...
    for i in range(0,len(list_of_messages)):
        if list_of_messages[i]!=[]:
            ...
            if flag==1:
                print("*********************************************************************************************")
                count=count+2
                print(list_of_clusters[maxi][0])
                print(list_of_clusters[i][0])
